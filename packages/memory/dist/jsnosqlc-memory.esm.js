...
class MemoryClient extends Client {
  constructor(url) {
    super({ url });
...
export { Client, ClientDataSource, Collection, Cursor, Driver, DriverManager, FieldCondition, Filter, MemoryClient, MemoryCollection, MemoryDriver, MemoryFilterEvaluator, UnsupportedOperationError, _driver };
