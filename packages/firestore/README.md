# @alt-javascript/jsnoslqc-firestore

[![Language](https://img.shields.io/badge/language-JavaScript-yellow.svg)](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
[![npm version](https://img.shields.io/npm/v/%40alt-javascript%2Fjsnoslqc-firestore)](https://www.npmjs.com/package/@alt-javascript/jsnoslqc-firestore)
...
import '@alt-javascript/jsnoslqc-firestore'; // self-registers with DriverManager

// Firestore Emulator
process.env.FIRESTORE_EMULATOR_HOST = 'localhost:8080';
const client = await DriverManager.getClient('jsnoslqc:firestore:my-project-id');
...
```
jsnoslqc:firestore:<gcp-project-id>
```

| URL | Description |
|---|---|
| `jsnoslqc:firestore:my-project` | Production Firestore |
| `jsnoslqc:firestore:emulator-project` | Firestore Emulator (set `FIRESTORE_EMULATOR_HOST`) |
...
```javascript
const client = await DriverManager.getClient('jsnoslqc:firestore:my-project', {
